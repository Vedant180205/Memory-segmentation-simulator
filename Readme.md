...
╚══════╝╚══════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝   ╚═╝   ╚═╝ ╚═════╝ ╚═╝  ╚═══╝
  ...
  └──────────┴──────────┴──────────┴──────────┴──────────┘
        Physical Address Space  ──────────────────────────▶
                    S I M U L A T O R   v1.0  |  Python + Tkinter
```
...
- **Live Memory Map** — Matplotlib visualization embedded in the UI updates on every change
...
- **Memory Stats** — Real-time usage percentage and external fragmentation metric
...
### 3. Assign Base Addresses
Choose a strategy from the **Allocation Strategy** panel, then click **🎯 Assign Bases**. The simulator places every segment into physical memory using that strategy and updates the map.
